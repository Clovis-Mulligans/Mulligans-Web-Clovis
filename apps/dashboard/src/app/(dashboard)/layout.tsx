...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-[#06070A]">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-30 flex flex-col border-r border-gray-800 bg-[#06070A] transition-all duration-300',
      ...
      >
        ...
        <div className="border-t border-gray-800 p-2">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-gray-400 hover:bg-gray-800 hover:text-white transition-colors"
          >
      ...
      >
        {/* Top header */}
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-gray-800 bg-[#06070A]/80 px-6 backdrop-blur-md">
