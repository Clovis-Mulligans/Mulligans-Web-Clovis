            ...
            <div className="text-center">
              ...
              <form onSubmit={handleSubmitCode} className="mt-6">
                ...
                <button
                  type="submit"
                  disabled={!code.trim()}
                  className="mt-4 w-full rounded-[10px] text-sm text-white transition-colors hover:opacity-90 disabled:opacity-50"
              ...
              <Link href="/login" className="mt-4 inline-block text-sm transition-colors hover:underline" style={{ color: '#1DC690', fontFamily: 'var(--font-sans)' }}>
                Back to Sign In
              </Link>
            </div>
          ) : (
            <>
              <h1 style={{ fontFamily: 'var(--font-sans)', fontWeight: 600, fontSize: '1.5rem', color: '#0D0D0D' }}>Reset your password</h1>
