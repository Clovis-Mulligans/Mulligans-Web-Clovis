...
export function Footer() {
  return (
    <footer className="mt-12" style={{ backgroundColor: '#EAEAE0', borderTop: '1px solid #D0D0C8' }}>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <span 
              ...
              style={{ color: '#1DC690', fontFamily: 'var(--font-sans)', letterSpacing: '2px' }}
            >
              MULLIGANS
            </span>
            <p 
            ...
            <div className="mt-3 flex gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium transition-opacity hover:opacity-80"
          ...
          <div className="flex items-center gap-5">
            {SOCIAL_LINKS.map((social) => (
              <a
                ...
                className="transition-colors hover:text-[#1DC690]"
                style={{ 
                  color: '#555555', 
